package com.xzq.composestudy.rally.ui.theme
...
import com.xzq.composestudy.ui.theme.ColorPalette
import com.xzq.composestudy.ui.theme.Typography1
...
fun RallyTheme(content: @Composable () -> Unit) {
    ...
    MaterialTheme(colors = ColorPalette, typography = Typography1, content = content)
}
